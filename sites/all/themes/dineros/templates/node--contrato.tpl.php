  ...
  <tr>
    ...
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Tiempo de ejecución: </td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2">Meses: <?php print $node->field_tiempo_de_ejecucion[und][0]['taxonomy_term']->name;?><br>
      Días:<?php print $node->field_tiempo_de_ejecucion_x_dias['und'][0]['value'];?></td></div>
  </tr>
    <tr>
    ...
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Municipios en el contrato:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2">
      <?php print render($content['field_municipio_contratro']);;?></td></div>
  </tr>
    <tr>
    ...
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Entidad interventora:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"> <?php print render($content['field_entidad_encargada_de_inter']);;?></td></div>
  </tr>
    <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Entidad contratante:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print render($content['field_entidad_contratante']);;?></td></div>
  </tr>
    <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Número de proceso:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print $node->field_numero_de_proceso_2['und'][0]['value'];?></td></div>
  </tr> 
    <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Fuente del contrato:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print $node->field_fuente_del_contrato['und'][0]['value'];?></td></div> 
  </tr>
</table>
<hr>
  <h2>Contratos asociados al principal</h2>
<div id="content-data2" style="text-align: left;"><?php print render($content['field_contratos_asociados_a_prin']);;?></div>
