...
$query->entityCondition('entity_type', 'node')
    ...
    ->propertyCondition('type', array('contratistas'));
...
<h1> <?php print $node->title; ?></h1>
    ...
    <div class="col-lg-12 col-md-12 col-xs-12">
            <table class="tg">
  <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">NIT:  </td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print $node->field_nit_contratista['und'][0]['value'];?></td></div>
  </tr>

    <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Contratos principales relacionados: </td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print render($content['field_contratos_relacionados_a_c']);;?></td></div>
  </tr>
    <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Contratos asociados relacionados:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print render($content['field_contrato_asociado_a_contra']);;?></td></div>
  </tr>
    <tr>
    <div class="col-lg-6  col-md-6 col-xs-6"><td class="tg-0lax" id="label2">Unión temporal o consorcio:</td></div>
     <div class="col-lg-6 col-md-6 col-xs-6"><td class="tg-0lax" id="content-data2"><?php print $node->field_union_temporal_o_consorcio[und][0]['taxonomy_term']->name;?></td></div>
  </tr>
